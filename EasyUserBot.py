...
def stopsessions():
    ...
    if not p:
        ...
        if platform.system() == "Windows":
            try:
                os.system('taskkill /fi "WINDOWTITLE eq Nomecliente_Console" /Im Cmd.exe /F /T')
                if sett['language'] == "Italian" or sett['language'] == "Italiano":
                    print("Operazione completata.")
                elif sett['language'] == "English" or sett['language'] == "Inglese":
                    print("Operation complete.")
...
def startdo():
    ...
    if platform.system() == "Windows":
        ...
        os.system('clear')
    print(colore + "4MS1X".center(width))
    print("4MS1X".center(width))
    print("4MS1X".center(width))
    print("4MS1X".center(width))
    print("4MS1X".center(width))
    print("4MS1X".center(width) + stop)
    print("4MS1X UserBot 1.0".center(width))
    sett = json.load(open(settings))
    p = os.listdir("sessions")
    parla = "\n"
